"""Evaluation metrics and orchestration for VLM captioning.

Covers the complete evaluation pipeline:
  - Loading predictions from JSONL
  - Reference-based metrics (BLEU, METEOR, ROUGE-L, CIDEr, SPICE, S_m)
  - Reference-free metrics (CLIPScore, RefCLIPScore)
  - Orchestrating computation and saving results to disk
"""
