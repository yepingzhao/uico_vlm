"""Shared evaluation functions used by both zero-shot and few-shot eval.

Extracted from scripts/run_eval.py and scripts/eval_fewshot.py which
contained ~80% identical code.
"""
