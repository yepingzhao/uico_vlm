...
\begin{table*}[t]\normalsize
	...
	\vspace{0.1in}
	\captionsetup{justification=justified}
	\caption{State-of-the-Art Performance Comparison on the UICO Benchmark Test Split. Note that, B@$N$, M, R, C, S, $\text{S}^{*}_m$, and $\text{S}_m$ denote BLEU@$N$, METEOR, ROUGE-L, CIDEr, SPICE, and two specialized semantic metrics, respectively. All values are reported as percentages (\%).}
	\vspace{-0.0in}
	\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l c c c c c c c c c c}
		\toprule             
		Methods & B@1  & B@2  & B@3  & B@4  & M    & R    & C     & S & S$^*_m$  & S$_m$\\	
		\hline \hline
		...
		\hline
		%		UIFormer & \textbf{50.05} & \textbf{40.56} & \textbf{35.06} & \textbf{31.37} & \textbf{24.31} & \textbf{45.11} & \textbf{123.89} & \textbf{21.16} & 0 & 0 \\
		UIFormer & \textbf{50.51} & \textbf{41.82} & \textbf{36.69} & \textbf{32.92} & \textbf{24.99} & \textbf{46.60} & 126.55 & 20.62 & \textbf{57.76} & \textbf{50.33} \\
		%		MFMCap-DINOv2 & \textbf{50.05} & \textbf{40.56} & \textbf{35.06} & \textbf{31.37} & \textbf{24.31} & \textbf{45.11} & \textbf{123.89} & \textbf{21.16} & 0 & 0 \\
		\hline
		\bottomrule
	\end{tabular*}
	\vspace{-0.2in}
...
\begin{table}[t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{cccccccc}
			...
			\midrule
			MAE & & 40.69 & 22.68 & 18.99 & 36.81 & 89.74 & 15.75 \\
			DINOv2 & & 46.62 & 27.08 & 21.61 & 41.23 & 105.34 & 18.30 \\
			CLIP & & \textbf{50.51} & \textbf{32.92} & \textbf{24.99} & \textbf{46.60} & \textbf{126.55} & \textbf{20.62} \\
			\bottomrule
		\end{tabular}
	}
